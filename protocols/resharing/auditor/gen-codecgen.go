...
const (
	// ----- content types ----
	codecSelferCcUTF89425 = 1
	codecSelferCcRAW9425  = 255
	// ----- value types used ----
	codecSelferValueTypeArray9425     = 10
	codecSelferValueTypeMap9425       = 9
	codecSelferValueTypeString9425    = 6
	codecSelferValueTypeInt9425       = 2
	codecSelferValueTypeUint9425      = 3
	codecSelferValueTypeFloat9425     = 4
	codecSelferValueTypeNil9425       = 1
	codecSelferBitsize9425            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil9425 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct9425 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer9425 struct{}

func codecSelfer9425False() bool { return false }
func codecSelfer9425True() bool  { return true }
...
func (x *DealingMessage) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil9425 {
		*(x) = DealingMessage{}
	} else if yyct2 == codecSelferValueTypeMap9425 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray9425 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct9425)
	}
}
...
func (x *FullWitness) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "WitIndex":
			x.WitIndex = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize9425))
		default:
			z.DecStructFieldNotFound(-1, string(yys3))
		} // end switch yys3
	} // end for yyj3
...
func (x codecSelfer9425) encSliceSlicecurve25519_Point(v [][]pkg1_curve25519.Point, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSliceSlicecurve25519_Point(v *[][]pkg1_curve25519.Point, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSlicecurve25519_Point(v []pkg1_curve25519.Point, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSlicecurve25519_Point(v *[]pkg1_curve25519.Point, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSlicecurve25519_Ciphertext(v []pkg1_curve25519.Ciphertext, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSlicecurve25519_Ciphertext(v *[]pkg1_curve25519.Ciphertext, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSlicecurve25519_SymmetricCiphertext(v []pkg1_curve25519.SymmetricCiphertext, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSlicecurve25519_SymmetricCiphertext(v *[]pkg1_curve25519.SymmetricCiphertext, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSliceSliceArray32uint8(v [][][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSliceSliceArray32uint8(v *[][][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSliceArray32uint8(v [][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSliceArray32uint8(v *[][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encArray32uint8(v *[32]uint8, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decArray32uint8(v *[32]uint8, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSlicecurve25519_Scalar(v []pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSlicecurve25519_Scalar(v *[]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encSlicePtrtocurve25519_Scalar(v []*pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSlicePtrtocurve25519_Scalar(v *[]*pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encMapPairIKcurve25519_Scalar(v map[PairIK]pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decMapPairIKcurve25519_Scalar(v *map[PairIK]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == codecSelferDecContainerLenNil9425 {
		*v = nil
	} else {
		if yyv1 == nil {
...
func (x codecSelfer9425) encSlicePtrtoArray16uint8(v []*[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decSlicePtrtoArray16uint8(v *[]*[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9425) encArray16uint8(v *[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9425) decArray16uint8(v *[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer9425
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
