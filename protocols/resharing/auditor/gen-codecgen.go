...
const (
	// ----- content types ----
	codecSelferCcUTF81794 = 1
	codecSelferCcRAW1794  = 255
	// ----- value types used ----
	codecSelferValueTypeArray1794     = 10
	codecSelferValueTypeMap1794       = 9
	codecSelferValueTypeString1794    = 6
	codecSelferValueTypeInt1794       = 2
	codecSelferValueTypeUint1794      = 3
	codecSelferValueTypeFloat1794     = 4
	codecSelferValueTypeNil1794       = 1
	codecSelferBitsize1794            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil1794 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct1794 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer1794 struct{}

func codecSelfer1794False() bool { return false }
func codecSelfer1794True() bool  { return true }
		...
		if yyr2 || yy2arr2 {
			...
			if yyq2[0] {
				if x.ComS == nil {
					...
					h.encSliceSlicecurve25519_PointXY(([][]pkg1_curve25519.PointXY)(x.ComS), e)
...
func (x *DealingMessage) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil1794 {
		*(x) = DealingMessage{}
	} else if yyct2 == codecSelferValueTypeMap1794 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray1794 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct1794)
	}
}
...
func (x *DealingMessage) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		switch string(yys3) {
		case "S":
			h.decSliceSlicecurve25519_PointXY((*[][]pkg1_curve25519.PointXY)(&x.ComS), d)
		case "V":
...
func (x *FullWitness) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "WitIndex":
			x.WitIndex = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize1794))
		default:
			z.DecStructFieldNotFound(-1, string(yys3))
		} // end switch yys3
	} // end for yyj3
...
func (x codecSelfer1794) encSliceSlicecurve25519_PointXY(v [][]pkg1_curve25519.PointXY, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
	...
	for yyv1 := range v {
		...
		if v[yyv1] == nil {
			...
			h.encSlicecurve25519_PointXY(([]pkg1_curve25519.PointXY)(v[yyv1]), e)
		} // end block: if v[yyv1] slice == nil
	}
	z.EncWriteArrayEnd()
}

func (x codecSelfer1794) decSliceSlicecurve25519_PointXY(v *[][]pkg1_curve25519.PointXY, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
	...
	if yyh1.IsNil {
		...
		for yyj1 = 0; (yyhl1 && yyj1 < yyl1) || !(yyhl1 || z.DecCheckBreak()); yyj1++ { // bounds-check-elimination
			...
			if yydb1 {
				...
				h.decSlicecurve25519_PointXY((*[]pkg1_curve25519.PointXY)(&yyv1[yyj1]), d)
			}
		}
		if yyj1 < len(yyv1) {
			yyv1 = yyv1[:yyj1]
...
func (x codecSelfer1794) encSlicecurve25519_PointXY(v []pkg1_curve25519.PointXY, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSlicecurve25519_PointXY(v *[]pkg1_curve25519.PointXY, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encSlicecurve25519_Ciphertext(v []pkg1_curve25519.Ciphertext, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSlicecurve25519_Ciphertext(v *[]pkg1_curve25519.Ciphertext, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encSlicecurve25519_SymmetricCiphertext(v []pkg1_curve25519.SymmetricCiphertext, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSlicecurve25519_SymmetricCiphertext(v *[]pkg1_curve25519.SymmetricCiphertext, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encSliceSliceArray32uint8(v [][][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSliceSliceArray32uint8(v *[][][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encSliceArray32uint8(v [][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSliceArray32uint8(v *[][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encArray32uint8(v *[32]uint8, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decArray32uint8(v *[32]uint8, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encSlicecurve25519_Scalar(v []pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSlicecurve25519_Scalar(v *[]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encSlicePtrtocurve25519_Scalar(v []*pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSlicePtrtocurve25519_Scalar(v *[]*pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encMapPairIKcurve25519_Scalar(v map[PairIK]pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decMapPairIKcurve25519_Scalar(v *map[PairIK]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == codecSelferDecContainerLenNil1794 {
		*v = nil
	} else {
		if yyv1 == nil {
...
func (x codecSelfer1794) encSlicePtrtoArray16uint8(v []*[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decSlicePtrtoArray16uint8(v *[]*[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1794) encArray16uint8(v *[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1794) decArray16uint8(v *[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer1794
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
