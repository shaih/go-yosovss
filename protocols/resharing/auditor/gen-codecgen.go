...
const (
	// ----- content types ----
	codecSelferCcUTF83347 = 1
	codecSelferCcRAW3347  = 255
	// ----- value types used ----
	codecSelferValueTypeArray3347     = 10
	codecSelferValueTypeMap3347       = 9
	codecSelferValueTypeString3347    = 6
	codecSelferValueTypeInt3347       = 2
	codecSelferValueTypeUint3347      = 3
	codecSelferValueTypeFloat3347     = 4
	codecSelferValueTypeNil3347       = 1
	codecSelferBitsize3347            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil3347 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct3347 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer3347 struct{}

func codecSelfer3347False() bool { return false }
func codecSelfer3347True() bool  { return true }
...
func (x *DealingMessage) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil3347 {
		*(x) = DealingMessage{}
	} else if yyct2 == codecSelferValueTypeMap3347 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray3347 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct3347)
	}
}
...
func (x *FullWitness) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "WitIndex":
			x.WitIndex = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize3347))
		default:
			z.DecStructFieldNotFound(-1, string(yys3))
		} // end switch yys3
	} // end for yyj3
...
func (x codecSelfer3347) encSliceSlicecurve25519_Point(v [][]pkg1_curve25519.Point, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSliceSlicecurve25519_Point(v *[][]pkg1_curve25519.Point, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSlicecurve25519_Point(v []pkg1_curve25519.Point, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSlicecurve25519_Point(v *[]pkg1_curve25519.Point, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSlicecurve25519_Ciphertext(v []pkg1_curve25519.Ciphertext, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSlicecurve25519_Ciphertext(v *[]pkg1_curve25519.Ciphertext, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSlicecurve25519_SymmetricCiphertext(v []pkg1_curve25519.SymmetricCiphertext, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSlicecurve25519_SymmetricCiphertext(v *[]pkg1_curve25519.SymmetricCiphertext, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSliceSliceArray32uint8(v [][][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSliceSliceArray32uint8(v *[][][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSliceArray32uint8(v [][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSliceArray32uint8(v *[][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encArray32uint8(v *[32]uint8, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decArray32uint8(v *[32]uint8, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSlicecurve25519_Scalar(v []pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSlicecurve25519_Scalar(v *[]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encSlicePtrtocurve25519_Scalar(v []*pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSlicePtrtocurve25519_Scalar(v *[]*pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encMapPairIKcurve25519_Scalar(v map[PairIK]pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decMapPairIKcurve25519_Scalar(v *map[PairIK]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == codecSelferDecContainerLenNil3347 {
		*v = nil
	} else {
		if yyv1 == nil {
...
func (x codecSelfer3347) encSlicePtrtoArray16uint8(v []*[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decSlicePtrtoArray16uint8(v *[]*[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3347) encArray16uint8(v *[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3347) decArray16uint8(v *[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer3347
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
