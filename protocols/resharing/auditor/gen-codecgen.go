...
const (
	// ----- content types ----
	codecSelferCcUTF8334 = 1
	codecSelferCcRAW334  = 255
	// ----- value types used ----
	codecSelferValueTypeArray334     = 10
	codecSelferValueTypeMap334       = 9
	codecSelferValueTypeString334    = 6
	codecSelferValueTypeInt334       = 2
	codecSelferValueTypeUint334      = 3
	codecSelferValueTypeFloat334     = 4
	codecSelferValueTypeNil334       = 1
	codecSelferBitsize334            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil334 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct334 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer334 struct{}

func codecSelfer334False() bool { return false }
func codecSelfer334True() bool  { return true }
...
func (x *DealingMessage) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil334 {
		*(x) = DealingMessage{}
	} else if yyct2 == codecSelferValueTypeMap334 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray334 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct334)
	}
}
...
func (x *FullWitness) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "WitIndex":
			x.WitIndex = (int)(z.C.IntV(r.DecodeInt64(), codecSelferBitsize334))
		default:
			z.DecStructFieldNotFound(-1, string(yys3))
		} // end switch yys3
	} // end for yyj3
...
func (x codecSelfer334) encSliceSlicecurve25519_Point(v [][]pkg1_curve25519.Point, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSliceSlicecurve25519_Point(v *[][]pkg1_curve25519.Point, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSlicecurve25519_Point(v []pkg1_curve25519.Point, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSlicecurve25519_Point(v *[]pkg1_curve25519.Point, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSlicecurve25519_Ciphertext(v []pkg1_curve25519.Ciphertext, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSlicecurve25519_Ciphertext(v *[]pkg1_curve25519.Ciphertext, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSlicecurve25519_SymmetricCiphertext(v []pkg1_curve25519.SymmetricCiphertext, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSlicecurve25519_SymmetricCiphertext(v *[]pkg1_curve25519.SymmetricCiphertext, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSliceSliceArray32uint8(v [][][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSliceSliceArray32uint8(v *[][][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSliceArray32uint8(v [][32]uint8, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSliceArray32uint8(v *[][32]uint8, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encArray32uint8(v *[32]uint8, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decArray32uint8(v *[32]uint8, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSlicecurve25519_Scalar(v []pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSlicecurve25519_Scalar(v *[]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encSlicePtrtocurve25519_Scalar(v []*pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSlicePtrtocurve25519_Scalar(v *[]*pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encMapPairIKcurve25519_Scalar(v map[PairIK]pkg1_curve25519.Scalar, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decMapPairIKcurve25519_Scalar(v *map[PairIK]pkg1_curve25519.Scalar, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == codecSelferDecContainerLenNil334 {
		*v = nil
	} else {
		if yyv1 == nil {
...
func (x codecSelfer334) encSlicePtrtoArray16uint8(v []*[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decSlicePtrtoArray16uint8(v *[]*[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer334) encArray16uint8(v *[16]uint8, e *codec1978.Encoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer334) decArray16uint8(v *[16]uint8, d *codec1978.Decoder) {
	var h codecSelfer334
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
